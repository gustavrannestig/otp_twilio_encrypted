...
import otp_twilio_encrypted.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(default="06cf5e8e255c3a65e90fcd94c5b8e779fad11f71", help_text='A random key used to generate tokens (hex-encoded).', max_length=40, validators=[otp_twilio_encrypted.models.key_validator])),
